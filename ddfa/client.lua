...
noose.weaponshops={
{x=2477.2534179688,y=-401.64010620117,z=94.816162109375,fbi=true,name="SWAT weapons",sprite=150,color=29,cost=0,weapon={WEAPON.COMBATPISTOL,WEAPON.PUMPSHOTGUNMK2,WEAPON.BULLPUPSHOTGUN,WEAPON.ASSAULTSMG,WEAPON.SMG,WEAPON.ADVANCEDRIFLE,WEAPON.CARBINERIFLE,WEAPON.SPECIALCARBINE,WEAPON.BZGAS},
...
FBISWAT={1949211328,1127131465,-1647941228,837858166,-1973172295},
...
sapr.carshops={
    ...
    {x=382.37777709961,y=803.44927978516,z=187.75993347168,fbi=true,sprite=56,color=2,name="SAPR ATV",cost=0,cars={-2128233223}},
}
noose.carshops={
...
join_faction[9]={func=switch_to_fbiswat,x=156.0267791748,y=-741.1162109375,z=242.15208435059,sprite=60,color=4,markercolor={128, 128, 255, 128},name="Join FBI SWAT",models={-1920001264},components={[10]={0,1}},removeweapons=true}
...
join_faction[22]={func=switch_to_elite,x=-625.57727050781,y=-131.6939239502,z=39.008563995361,sprite=432,color=4,markercolor={255, 255, 255, 128},name="Join Elite Security",models=SKINS.ELITE}
join_faction[23]={func=switch_to_paramedics,x=294.99197387695,y=-1447.7286376953,z=29.966623306274,sprite=60,color=8,markercolor={255, 200, 128, 128},name="Join Medics",models=SKINS.MEDICS,removeweapons=true}
        ...
        if IsPedInAnyVehicle(ped) then
            ...
            if veh~=nil then
                if garbage.truck_models[GetEntityModel(veh)] then
                    ...
                    if close_enough then --removing broken blips
...
taxidriver.hackernames={"G4057","Ghost","Cypher","Neuromancer","N3uromancer",}
...
taxidriver.score=10
taxidriver.minscore=0
taxidriver.chance=100
                ...
                while true do
                    ...
                    elseif math.abs(pos.x-x)+math.abs(pos.y-y)<30.0 then
                        ...
                        if taxidriver.score<taxidriver.minscore or math.random(1,100)>taxidriver.chance then
                            ...
                            taxidriver.mission_state=string.format("~y~Error 0x%8X",math.random(0,0xFFFFFFFF))
                            ...
                            while true do
                                ...
                                elseif taxidriver.fucked_up then
                                    ...
                                    break
                                elseif GetVehiclePedIsUsing(me)~=veh then
                                    taxidriver.fucked_up=true
                                    break
                                elseif GetVehicleEngineHealth(veh)<300 then
                                    taxidriver.fucked_up=true
  ...
  AddEventHandler(event.help, function()
    --if text=="/help" then
      ...
      while showhelp do
        ...
        WriteText(0,"Go to ~b~bus stop and sit on bench~s~, by pressing ~b~U~s~. Then select ~b~used car shop~s~.",0.3,255,255,255,255,leftside,stringfirstvert+stringsize*12)
...
Citizen.CreateThread(function()
    ...
    local busstops={
        ...
        {x=-642.86053466797,y=-136.8529510498,z=37.835742950439,price=medium,name="Elite city hall"},
